...
Basemap assets (`MEL.pmtiles`, `buildings_index.json`, `roads.geojson`,
`runways_taxiways.geojson`) are **unchanged from v1.0.x** — load time and
memory are the same; this release targets in-play simulation speed. Asset
slimming is planned separately.
